...
namespace WinsockPacketEditor
{
    public partial class SocketProxy_Form : Form
    {
        ...
        {
            this.ExitMainForm();
            this.niProxy.Visible = false;
            this.niProxy.Dispose();
        }

        private void SocketProxy_Form_Resize(object sender, EventArgs e)
        {
            try
            {
        ...
        private void niProxy_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            try
            {
        ...
        private void bRefreshIP_Click(object sender, EventArgs e)
        {
            try
            {
                this.InitProxyIPAppoint();
