    ...
    public partial class Socket_RobotForm : Form
    {
        ...
        private void InitFrom()
        {
            try
            {
                ...
                this.txtHotKey.Text = sriSelect.HotKey;
        ...
        private void bSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.sriSelect.HotKey = this.txtHotKey.Text;
        ...
        private void bHotKey_Click(object sender, EventArgs e)
        {
            try
            {
                if (string.IsNullOrEmpty(this.txtHotKey.Text))
                {
                    Socket_Operation.ShowMessageBox("请先在右侧输入框录制快捷键");
                    return;
                }
                ...
                Socket_Operation.ShowMessageBox("快捷键已启用并保存：" + this.txtHotKey.Text);
            }
            catch (Exception ex)
            {
                Socket_Operation.DoLog(MethodBase.GetCurrentMethod().Name, ex.Message);
